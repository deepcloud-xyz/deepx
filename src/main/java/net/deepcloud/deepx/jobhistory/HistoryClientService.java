...
public class HistoryClientService extends AbstractService {
  ...
  protected void serviceStart() throws Exception {
    ...
    InetSocketAddress address = conf.getSocketAddr(
        ...
        DeepXConfiguration.DEEPX_HISTORY_ADDRESS,
    ...
    server =
        rpc.getServer(HSClientProtocol.class, protocolHandler, address,
            ...
            conf.getInt(DeepXConfiguration.DEEPX_HISTORY_CLIENT_THREAD_COUNT,
                DeepXConfiguration.DEFAULT_DEEPX_HISTORY_CLIENT_THREAD_COUNT));
    ...
    server.start();
    this.bindAddress = conf.updateConnectAddr(DeepXConfiguration.DEEPX_HISTORY_BIND_HOST,
        DeepXConfiguration.DEEPX_HISTORY_ADDRESS,
        conf.get(DeepXConfiguration.DEEPX_HISTORY_ADDRESS, DeepXConfiguration.DEFAULT_DEEPX_HISTORY_ADDRESS),
  ...
  protected void initializeWebApp(Configuration conf) {
    ...
    InetSocketAddress bindAddress = DeepXWebAppUtil.getJHSWebBindAddress(conf);
    // NOTE: there should be a .at(InetSocketAddress)

    try {
      Method webAppBuild = WebApps.Builder.class.getMethod("build", WebApp.class);
      webAppBuild.invoke(WebApps.$for("jobhistory", HistoryClientService.class, this, "ws").with(conf).withHttpSpnegoKeytabKey(DeepXConfiguration.DEEPX_WEBAPP_SPNEGO_KEYTAB_FILE_KEY).withHttpSpnegoPrincipalKey(DeepXConfiguration.DEEPX_WEBAPP_SPNEGO_USER_NAME_KEY).at(NetUtils.getHostPortString(bindAddress)), webApp);
      ...
      WebApps
          ...
          .withHttpSpnegoKeytabKey(
              DeepXConfiguration.DEEPX_WEBAPP_SPNEGO_KEYTAB_FILE_KEY)
          .withHttpSpnegoPrincipalKey(
              DeepXConfiguration.DEEPX_WEBAPP_SPNEGO_USER_NAME_KEY)
    ...
    String connectHost = DeepXWebAppUtil.getJHSWebappURLWithoutScheme(conf).split(":")[0];
    DeepXWebAppUtil.setJHSWebappURLWithoutScheme(conf,

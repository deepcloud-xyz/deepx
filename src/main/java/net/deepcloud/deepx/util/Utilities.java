package net.deepcloud.deepx.util;
...
public final class Utilities {
  ...
  public static Path getRemotePath(DeepXConfiguration conf, ApplicationId appId, String fileName) {
    String pathSuffix = appId.toString() + "/" + fileName;
    Path remotePath = new Path(conf.get(DeepXConfiguration.DEEPX_STAGING_DIR, DeepXConfiguration.DEFAULT_DEEPX_STAGING_DIR),
        pathSuffix);
